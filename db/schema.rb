...
ActiveRecord::Schema.define(version: 20160413212915) do
  ...
  create_table "appointments", force: :cascade do |t|
    ...
    t.date     "approximate_event_date"
  end

  create_table "child_colors", force: :cascade do |t|
    t.string   "name"
    t.string   "hex"
    t.integer  "parent_color_id"
    t.datetime "created_at",      null: false
    t.datetime "updated_at",      null: false
  end

  add_index "child_colors", ["parent_color_id"], name: "index_child_colors_on_parent_color_id", using: :btree

  create_table "competitor_colors", force: :cascade do |t|
    t.string   "name"
    t.string   "hex"
    t.integer  "parent_color_id"
    t.datetime "created_at"
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.boolean  "black_tie"
    t.boolean  "prom_rep"
    t.boolean  "school_fundraiser",       default: false
    t.string   "school_city"
    t.string   "school_state"
    t.string   "school_zip_code"
    t.string   "school_street_address"
    t.string   "event_date_string"
    t.string   "other_explain"
    t.string   "number_juniors"
    t.string   "number_seniors"
    t.boolean  "social_event_fundraiser", default: false
    t.integer  "high_school_id"
    t.boolean  "exported",                default: false
  end

  add_index "events", ["high_school_id"], name: "index_events_on_high_school_id", using: :btree
  add_index "events", ["location_id"], name: "index_events_on_location_id", using: :btree
  add_index "events", ["look_id"], name: "index_events_on_look_id", using: :btree
  ...
  add_index "favorites", ["variant_id"], name: "index_favorites_on_variant_id", using: :btree
  ...
  create_table "group_codes", force: :cascade do |t|
    t.integer  "number"
    t.integer  "location_id"
    t.integer  "event_id"
    t.datetime "created_at"
  ...
  add_index "identities", ["user_id", "provider", "uid"], name: "index_identities_on_user_id_and_provider_and_uid", unique: true, using: :btree
  add_index "identities", ["user_id"], name: "index_identities_on_user_id", using: :btree

  create_table "locations", force: :cascade do |t|
    t.string   "store_num",                                                                                      null: false
    t.string   "dist_manager"
    ...
    t.text     "shorthand"
    t.string   "email"
    t.string   "regional_district_manager_email"
    t.string   "district_manager_email"
    t.string   "area_manager_email"
    t.string   "manager_email"
    t.integer  "mon_open"
    t.integer  "mon_close"
    t.integer  "tues_open"
    t.integer  "tues_close"
    t.integer  "wed_open"
    t.integer  "wed_close"
    t.integer  "thurs_open"
    t.integer  "thurs_close"
    t.integer  "fri_open"
    t.integer  "fri_close"
    t.integer  "sat_open"
    t.integer  "sat_close"
    ...
    t.integer  "sun_close"
    t.string   "apple_url"
    t.text     "manager_content_block"
    t.boolean  "tuxedos_service",                 default: true
    t.boolean  "suits_service",                   default: true
    t.boolean  "quinceanera_service",             default: false
    t.boolean  "accessories_service",             default: false
    t.boolean  "photography_service",             default: false
    t.boolean  "invitations_service",             default: false
    t.boolean  "video_service",                   default: false
    t.boolean  "dj_service",                      default: false
    t.text     "event_content_block_1"
    t.text     "event_content_block_2"
    t.text     "event_content_block_3"
    t.string   "event_link_text_1"
    t.string   "event_link_text_2"
    t.string   "event_link_text_3"
    t.boolean  "spanish",                         default: false
    t.string   "manager_image_file_name"
    t.string   "manager_image_content_type"
    t.integer  "manager_image_file_size"
    t.datetime "manager_image_updated_at"
    t.string   "content_image_1_file_name"
    t.string   "content_image_1_content_type"
    t.integer  "content_image_1_file_size"
    t.datetime "content_image_1_updated_at"
    t.string   "content_image_2_file_name"
    t.string   "content_image_2_content_type"
    t.integer  "content_image_2_file_size"
    t.datetime "content_image_2_updated_at"
    t.string   "content_image_3_file_name"
    t.string   "content_image_3_content_type"
    t.integer  "content_image_3_file_size"
    t.datetime "content_image_3_updated_at"
    ...
    t.string   "tuxedos_service_link",            default: "/catalog/products?category=tuxedos"
    t.string   "suits_service_link",              default: "/catalog/products?category=suits"
    t.string   "accessories_service_link",        default: "/catalog/products?category=studs-and-links"
    t.string   "photography_service_link",        default: "http://www.alsphotography.com/"
    t.string   "video_service_link",              default: "http://www.alsphotography.com/Packages.aspx?Type=2"
    t.string   "dj_service_link",                 default: "http://www.alsphotography.com/Packages.aspx?Type=1"
    t.string   "invitations_service_link",        default: "http://alsformalwear.carlsoncraft.com/"
    t.string   "quinceanera_service_link",        default: "/quinceanera"
  end
  ...
  create_table "parent_colors", force: :cascade do |t|
  ...
  create_table "school_group_sales", force: :cascade do |t|
    t.string   "first_name"
    t.string   "last_name"
    t.string   "street_address"
    t.string   "city"
  ...
  create_table "spree_products", force: :cascade do |t|
    ...
    t.boolean  "tuxedo",               default: false, null: false
    t.string   "family"
  end
  ...
  add_index "spree_users", ["email"], name: "email_idx_unique", unique: true, where: "(deleted_at IS NULL)", using: :btree
  ...
  create_table "spree_variants", force: :cascade do |t|
    ...
    t.integer  "tax_category_id"
    t.datetime "updated_at"
    t.string   "byt_image_file_name"
    t.string   "byt_image_content_type"
    t.integer  "byt_image_file_size"
    t.datetime "byt_image_updated_at"
    t.string   "secondary_byt_image_file_name"
    t.string   "secondary_byt_image_content_type"
    t.integer  "secondary_byt_image_file_size"
    t.datetime "secondary_byt_image_updated_at"
  end
